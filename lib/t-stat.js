  ...
  task () {
    if (this._proxy) {
      ...
      if (msgList.fromClient.size() > 0) {
        promises.push(this._proxy.reportMicMsg(msgList.fromClient.valueOf(), true, { packetType: 1 })
          .catch(() => Promise.resolve()))
      }
      if (msgList.fromServer.size() > 0) {
        promises.push(this._proxy.reportMicMsg(msgList.fromClient.valueOf(), false, { packetType: 1 })
          .catch(() => Promise.resolve()))
      }
      if (promises.length) {
